...
namespace CoronaApp.Api.Controllers
{
    ...
    public class PatientController : ControllerBase
    {
        ...
        [HttpDelete]
        public async Task<string> DeleteLocation([FromBody] Location location,string patientId)
        {
            ...
            l.Locations == location.Locations &&
            l.City == location.City);

            if (patient.LocationsList.Remove(locationToDelete))
            {
